/*!
 * RAGina-Pro.js v2.1.0
 * Mentalist RAG — now with sassy voice! (Smallest.ai via Cloudflare Worker)
...
(function (global) {
  ...
  // ── TTS (Smallest.ai via Worker) ──────────────────────
  async function speakText(text, voiceUrl, voiceId, speed) {
    ...
    try {
      ...
      console.warn('RAGina voice failed:', err.message);
    }
  }
